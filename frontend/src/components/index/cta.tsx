...
const whiteDot = <span className="text-white">.</span>;
...
const CTA = () => {
  return (
    <div className={styles.readyToStart}>
      ...
      <h2 className="my-3 custom-dull">Set{whiteDot} Ready{whiteDot} <span className="custom-bright">Go{whiteDot}</span></h2>
