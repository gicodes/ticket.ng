export const Tips = [
  ...
  },
  {
    ...
    text: "Easily log issues, requests, or tasks using the 'New Ticket' button. Add priority, assignee, and due date to get started!",
    action: "Next",
    anchor: '#new-ticket-btn',
  },
  {
    title: 'Switch Between Views 👀',
    text: "Use the view toggle to switch between Table and Board views — perfect for organizing your workflow your way.",
    action: "Next",
    anchor: '#view-toggle',
  },
  {
