export const TEAM = [
  { name: "Gideon Iduma", role: "Founder & Product Lead" },
  { name: "Amira Tayo", role: "Design & Experience" },
  { name: "Kehinde Okoro", role: "Engineering" },
  { name: "Mason Lee", role: "Growth & Partnerships" },
];
